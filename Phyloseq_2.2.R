...
new_filtering_parameter = function(community, rule_asv_count, rule_asv_length, rule_min_prevalence){
    ...
    if(community == "S5"){
        ...
        subset_file = subset(subset_file, select = -plate2_2529R_R_F_NS1_week5_S5_L0)
    }
...
applying_best_filters_across_all = function(community,merged_file_tunning){
    ...
    special_cols = c(special_cols, "sum")
    ...
    write.csv(final_file, paste0(community,"_filtered_ASVs_count600_len400_prev20.csv"), row.names = FALSE)
}
